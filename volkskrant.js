// URL endpoint
const endpoints = ['https://opendata.rdw.nl/resource/m9d7-ebf2.json?$limit=10000', 'https://opendata.rdw.nl/resource/8ys7-d773.json?$limit=10000'];
...
getData(endpoints)
	...
	.then((data) => {
		...
		mergeDatasets(fuelInfo, carInfo);
	});
